<div>
    <div class="bg-white p-4 sm:px-6 sm:py-4 border-b border-gray-150">
        <h3 class="text-lg leading-6 font-medium text-gray-900">
            {{ __('Edit Pertanyaan #:value', ['value' => $testObservation->id]) }}
        </h3>
    </div>
    ...
    <div class="bg-white text-sm sm:p-6">
        ...
        <div class="w-full mt-5">
            <x-input-label for="question" :value="__('Pertanyaan')"></x-input-label>
            <textarea id="question" wire:model="question"
                class="w-full h-48 text-sm border-gray-300 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm @error('question') border-red-500 @enderror"></textarea>
