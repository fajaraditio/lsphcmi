<div>
    <div class="bg-white p-4 sm:px-6 sm:py-4 border-b border-gray-150">
        <h3 class="text-lg leading-6 font-medium text-gray-900">
            {{ __('Submit Tugas Praktik untuk Asesi') }}
        </h3>
    </div>

    <div class="bg-white text-sm sm:p-6">
        <div class="w-full">
            <p>Apakah Anda yakin ingin submit tugas praktik ini untuk asesi {{ $testSchedule->participant->name }}?</p>
        </div>
    </div>
