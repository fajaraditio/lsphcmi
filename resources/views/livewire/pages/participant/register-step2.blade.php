                ...
                <div id="form-wizard" class="p-8">
                    ...
                    <div class="sm:flex w-full mt-5">
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-text-input id="name" type="text" :value="old('participant.name')"
                                class="block mt-1 w-full text-sm" :error="$errors->has('participant.name')"
                        ...
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-text-input id="identity_number" type="text" :value="old('participant.identity_number')"
                                class="block mt-1 w-full text-sm" :error="$errors->has('participant.identity_number')"
                    ...
                    <div class="sm:flex w-full">
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-text-input id="birth_place" type="text" :value="old('participant.birth_place')"
                                ...
                                placeholder="Masukkan Tempat Lahir, mis: Jakarta" class="block mt-1 w-full text-sm"
                        ...
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-text-input id="birth_date" type="date" :value="old('participant.birth_date')"
                                class="block mt-1 w-full text-sm" :error="$errors->has('participant.birth_date')"
                    ...
                    <div class="sm:flex w-full">
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-select-input id="gender" :value="old('participant.gender')" class="block mt-1 w-full text-sm"
                    ...
                    <div class="sm:flex w-full">
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-text-input id="nationality" type="text" :value="old('participant.nationality')"
                                class="block mt-1 w-full text-sm" :error="$errors->has('participant.nationality')"
                    ...
                    <div class="sm:flex w-full">
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-text-input id="email" type="email" :value="old('participant.email')"
                                class="block mt-1 w-full text-sm" :error="$errors->has('participant.email')"
                    ...
                    <div class="sm:flex w-full">
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-textarea-input id="address" class="block mt-1 w-full text-sm h-32"
                        ...
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-text-input id="city" type="text" :value="old('participant.city')"
                                class="block mt-1 w-full text-sm sm:w-1/2" :error="$errors->has('participant.city')"
                            ...
                            <x-text-input id="zip_code" type="number" :value="old('participant.zip_code')"
                                class="block mt-1 w-full text-sm sm:w-1/2" :error="$errors->has('participant.zip_code')"
                    ...
                    <div class="sm:flex w-full">
                        <div class="w-full sm:w-1/3 my-2 sm:mr-2">
                            ...
                            <x-text-input id="home_phone_number" type="text"
                                :value="old('participant.home_phone_number')" class="block mt-1 w-full text-sm"
                        ...
                        <div class="w-full sm:w-1/3 my-2 sm:mr-2">
                            ...
                            <x-text-input id="office_phone_number" type="text"
                                :value="old('participant.office_phone_number')" class="block mt-1 w-full text-sm"
                        ...
                        <div class="w-full sm:w-1/3 my-2 sm:mr-2">
                            ...
                            <x-text-input id="cell_phone_number" type="text"
                                :value="old('participant.cell_phone_number')" class="block mt-1 w-full text-sm"
                    ...
                    <div class="sm:flex w-full mt-5">
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-text-input id="company_name" type="text" :value="old('participant.company_name')"
                                class="block mt-1 w-full text-sm" :error="$errors->has('participant.company_name')"
                    ...
                    <div class="sm:flex w-full">
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-text-input id="position_at_work" type="text" :value="old('participant.position_at_work')"
                                class="block mt-1 w-full text-sm" :error="$errors->has('participant.position_at_work')"
                    ...
                    <div class="sm:flex w-full">
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-textarea-input id="company_address" class="block mt-1 w-full text-sm h-32"
                        ...
                        <div class="w-full sm:w-1/2 my-2 sm:mr-2">
                            ...
                            <x-text-input id="company_city" type="text" :value="old('participant.company_city')"
                                class="block mt-1 w-full text-sm sm:w-1/2" :error="$errors->has('participant.company_city')"
                            ...
                            <x-text-input id="company_zip_code" type="number"
                                :value="old('participant.company_zip_code')" class="block mt-1 w-full text-sm sm:w-1/2"
                    ...
                    <div class="sm:flex w-full">
                        <div class="w-full sm:w-1/3 my-2 sm:mr-2">
                            ...
                            <x-text-input id="company_phone_number" type="text"
                                :value="old('participant.company_phone_number')" class="block mt-1 w-full text-sm"
                        ...
                        <div class="w-full sm:w-1/3 my-2 sm:mr-2">
                            ...
                            <x-text-input id="company_fax_number" type="text"
                                :value="old('participant.company_fax_number')" class="block mt-1 w-full text-sm"
                        ...
                        <div class="w-full sm:w-1/3 my-2 sm:mr-2">
                            ...
                            <x-text-input id="company_cell_phone_number" type="text"
                                :value="old('participant.company_cell_phone_number')" class="block mt-1 w-full text-sm"
